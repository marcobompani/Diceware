...
parser.add_argument('-l', '--lang', default='en', help='set the language of the list to use (default en)')
parser.add_argument('-w', '--words', type=int, default=8, help='set the password length in words (default 8)')
